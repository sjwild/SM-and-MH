...
p_confounding <- ggdag(confounding) + lims(y = c(-1, 1)) + labs(title = "Confounding")
...
p_collider <- ggdag(collider) + lims(y = c(-1, 1)) + labs(title = "Collider")
...
p_mediator <- ggdag(mediator) + lims(y = c(-1, 1)) + labs(title = "Mediator")
